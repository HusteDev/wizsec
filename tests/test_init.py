...
class TestAllExports:
    ...
    def test_all_contains_exception_names(self):
        import wizsec
        expected = [
            "WizError", "WizAuthenticationError", "WizAPIError",
            "WizConfigurationError", "WizCredentialsError", "WizRateLimitError",
            "WizQueryError", "WizSchemaValidationError", "WizReportError",
